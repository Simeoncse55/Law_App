...
class FirstSchduleContent extends StatefulWidget {
  const FirstSchduleContent({super.key});

  @override
  State<FirstSchduleContent> createState() => _FirstSchduleContentState();
}

class _FirstSchduleContentState extends State<FirstSchduleContent> {
  @override
    ...
    return Scaffold(
      backgroundColor: Colors.black,
        appBar: AppBar(
          centerTitle: true,
          backgroundColor: Colors.black,
          title: Text('Order',style: GoogleFonts.poppins(fontWeight: FontWeight.bold),),),
